export default function LearnCard({
  ...
  return (
    <div
      ...
      bg-blue-200/10 dark:bg-gray-800/70 
    ...
    >
      ...
      <div className="w-full md:w-1/2 text-center md:text-left">
        <h3 className="text-2xl font-bold text-blue-200 dark:text-blue-300 flex items-center gap-2 justify-center md:justify-start">
          <span className="text-4xl"></span> {title}
        </h3>
        <p className="mt-4 text-xl pb-8 text-white-900 dark:text-white-100 leading-relaxed">
          {description}
        </p>
