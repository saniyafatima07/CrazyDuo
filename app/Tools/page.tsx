  ...
  const tools = [
    {
      name: "Truecaller",
      icon: <PhoneIcon />,
      description: "Identify unknown callers, block spam calls and SMS. Community-powered caller ID and spam protection.",
      type: "Mobile App",
      price: "Free",
      playStoreLink: "https://play.google.com/store/apps/details?id=com.truecaller",
      features: ["Caller ID", "Spam Detection", "Call Blocking", "SMS Protection"]
    },
    {
      name: "Google Messages Spam Protection",
      icon: <MessageIcon />,
      description: "Built-in spam protection that flags suspicious SMS like fake UPI links, KYC expiry messages, and phishing attempts.",
      type: "Android Feature",
      price: "Free",
      playStoreLink: "https://play.google.com/store/apps/details?id=com.google.android.apps.messaging",
      features: ["SMS Filtering", "Phishing Detection", "UPI Fraud Protection", "Auto-categorization"]
    },
      ...
      
    {
      ...
      icon: <AlertIcon />,
      description: "Official RBI portal to report unauthorized digital transactions and seek assistance for payment frauds.",
      type: "Web Portal",
      price: "Free",
      playStoreLink: null,
      webLink: "https://sachet.rbi.org.in",
      features: ["Report Fraud", "Transaction Disputes", "Official Support", "Regulatory Backing"]
    },
    {
      name: "CyberDost",
      icon: <ShieldIcon color="text-red-400" />,
      description: "Government of India's cybersecurity awareness initiative providing tips, reporting mechanisms, and educational resources.",
      type: "Government Initiative",
      price: "Free",
      playStoreLink: "https://play.google.com/store/apps/details?id=in.gov.cyberdost",
      webLink: "https://cyberdost.gov.in",
      features: ["Cyber Education", "Incident Reporting", "Security Tips", "Government Backed"]
    }
  ];
      ...
      <div className="backdrop-blur-sm ">
        <div className="max-w-2xl mx-auto px-6 py-6">
          <div className="text-center">
            ...
            <p className="text-blue-200 text-2xl justify-center flex  w-3xl pl-0  ">Essential Tools to protect yourself from cyber crime 
            </p>
          </div>
        </div>
      </div>
